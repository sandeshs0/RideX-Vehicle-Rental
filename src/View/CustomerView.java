...
public class CustomerView extends javax.swing.JFrame {
    ...
    tableModel.setRowCount(0);
       ...
       try {
            ...
            String tbdata[]={full_name,phone_number,email,address};
    ...
    private void btnaddcustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddcustomerActionPerformed
        boolean srijan = validation();
            if(srijan==true){
                ...
                try {
    String sql = "INSERT INTO customer (full_name, phone_number, email, address) VALUES (?, ?, ?, ?)";
    pstmt = conn.prepareStatement(sql);
    pstmt.setString(1, txtfullname.getText());
    pstmt.setString(2, txtphone.getText());
    pstmt.setString(3, txtemail.getText());
    pstmt.setString(4, txtaddress.getText()); // Insert the value "Dummy Address" into the "address" column
    
    int rowsAffected = pstmt.executeUpdate();
    
    if (rowsAffected > 0) {
        System.out.println("Data inserted");
        JOptionPane.showMessageDialog(this, "Successfully inserted", "EMPLOYEE", JOptionPane.INFORMATION_MESSAGE);
        
        reset();
    } else {
        System.out.println("Data insertion failed");
        JOptionPane.showMessageDialog(this, "Failed to insert data", "EMPLOYEE", JOptionPane.ERROR_MESSAGE);
    }
} catch (SQLException ex) {
    ex.printStackTrace();
    JOptionPane.showMessageDialog(this, "An error occurred: " + ex.getMessage(), "EMPLOYEE", JOptionPane.ERROR_MESSAGE);
} finally {
    try {
        if (pstmt != null) {
            pstmt.close();
...
Connection conn5= dbConnection.dbconnect();
        try{
            ...
            String address = String.valueOf(rs.getString("address"));
                ...
                Object[] obj = {full_name,phone_number,email,address};
...
//            tableModel.fireTableDataChanged();
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdateActionPerformed
            try{
                ...
                PreparedStatement stmt7 = conn7.prepareStatement("UPDATE customer set full_name=?,email=?,address=? where phone_number=?");
                stmt7.setString(1, fullname);
                stmt7.setString(2, email);
                stmt7.setString(3, phone);
                stmt7.setString(4, address);
                stmt7.executeUpdate();
